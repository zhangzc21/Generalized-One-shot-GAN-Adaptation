...
import bz2
import argparse
from face_align.face_align import image_align
from face_align.landmark_detector import LandmarksDetector
...
if __name__ == "__main__":
    ...
    parser.add_argument('--raw_dir', default = r'',
                        help = 'Directory with raw images for face alignment', type = str)
    parser.add_argument('--aligned_dir', default = r'', help = 'Directory for storing aligned images',
                        type = str)
    parser.add_argument('--output_size', default = 1024, help = 'The dimension of images for input to the model',
                        type = int)
    ...
    with dnnlib.util.open_url(LANDMARKS_MODEL_URL) as f:
        landmarks_model_path = unpack_bz2(
            r'C:\Users\ROG\.cache\dnnlib\downloads' + r'\shape_predictor_68_face_landmarks.dat.bz2')
